...
docker login
docker tag pd211-java:latest mirada032/pd211-java:latest
docker push mirada032/pd211-java:latest

docker pull mirada032/pd211-java:latest
docker ps -a
docker run -d --restart=always -v /volumes/pd211/images:/app/images --name pd211_container -p 5062:8083 mirada032/pd211-java
...
docker stop pd211_container
docker rm pd211_container
docker run -d --restart=always --name pd211_container -p 5062:8083 mirada032/pd211-java
